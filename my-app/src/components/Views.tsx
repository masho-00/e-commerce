...
const Views = () => {
  ...
  const slideInterval: React.MutableRefObject<number | null>= useRef<number | null>(null);
  ...
  return (
    <div >
        <h1 data-aos='zoom-in' className="text-3xl md:text-5xl lg:text-6xl underline text-center my-20 font-bold">Explore our Products</h1>
    <div
    ...
    >
      <img
        ...
        className="rounded-xl shadow-2xl w-full h-72 md:h-[500px] object-cover transition-opacity duration-700"
